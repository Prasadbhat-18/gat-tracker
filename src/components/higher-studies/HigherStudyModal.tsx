...
import { HigherStudyForm } from "./HigherStudyForm"
...
interface HigherStudyModalProps {
  students: StudentOption[]
  buttonText?: string
  buttonClassName?: string
}

export function HigherStudyModal({
  students,
  buttonText = "Add Higher Study Record",
  buttonClassName,
}: HigherStudyModalProps) {
